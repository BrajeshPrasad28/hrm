...
<div class="row ml-4">
   <div class="text-center">
      <form action="" method="post">
         <select class="btn" name="year" id='year' style="border: 1px solid black; border-radius: 0.25rem 0.25rem 0.25rem 0.25rem; position: absolute; z-index: 100;" onmousedown="if(this.options.length>10){this.size=10;}"  onchange='this.size=0;' onblur="this.size=0;" required>
   ...
   <div id="editor"></div>
   <button type="button" class="btn btn-secondary ml-5 mb-3" onclick="printDiv('print_year_Wise')"><i class="fa fa-file-pdf-o"></i> Print</button>
<?php
  }
  mysqli_close($con);
 ?>
