      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-header" style="background: black;">
               <h4 class="modal-title" style="color:white;">Update Employee Details</h4>
               <button type="button" class="close" data-dismiss="modal" style="color:white;">&times;</button>
            </div><br>
            <div class="heading">
              <center><h4>Employee Id- <span id="employee_id"></span> test: <?php echo $employee_id?> </h4></center>
            </div><br>
            <!-- Modal body -->
               ...
               <form class="form-horizontal" method="POST"  enctype="multipart/form-data">
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-9">
                           <select class="form-control" id="schedule_id" name="schedule_id" required="">
                              <option value="" selected=""><?php echo $c['time_in'].'-'.$c['time_out'];?></option>
                              <option value="">- Select -</option>
                              <?php
                  ...
                  <div class="modal-footer">
                    <button type="button"  class="btn btn-danger" data-dismiss="modal" style="color:white;">Close</button>
                     <button type="submit" name="edit"  name='emp_id' value='".$b['emp_id']."' class="btn btn-primary">Update</button>
                  </div>
               </form>
            </div>
         </div>
