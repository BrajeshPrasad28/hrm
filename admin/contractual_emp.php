           ...
           <?php
            ...
            <div class="content-inner">
               <table id="emplist" class="table table-stripped table-bordered order-column" style="width: 100%;">
                  ...
                  <tbody>
                     <?php
                  $query = mysqli_query($con, "SELECT emp_id, photo, created_on, job_type, first_name, last_name, gender, designation.d_name,schedules.time_in,schedules.time_out FROM ((employees inner join designation on employees.d_name=designation.d_id) inner join schedules on schedules.id=employees.schedule_id) where job_type = 'Contractual'");
